...
#include "MyModeInteractiveTool.generated.h"
 ...
 */
UCLASS()
class MYMODE_API UMyModeInteractiveToolBuilder : public UInteractiveToolBuilder
{
	GENERATED_BODY()
 ...
 */
UCLASS(Transient)
class MYMODE_API UMyModeInteractiveToolProperties : public UInteractiveToolPropertySet
{
	GENERATED_BODY()

public:
	UMyModeInteractiveToolProperties();
 ...
 */
UCLASS()
class MYMODE_API UMyModeInteractiveTool : public UInteractiveTool, public IClickDragBehaviorTarget
{
	GENERATED_BODY()
...
protected:
	...
	UPROPERTY()
	TObjectPtr<UMyModeInteractiveToolProperties> Properties;
