...
#include "MyModeInteractiveTool.h"
...
#define LOCTEXT_NAMESPACE "UMyModeInteractiveTool"

/*
 * ToolBuilder
 */

UInteractiveTool* UMyModeInteractiveToolBuilder::BuildTool(const FToolBuilderState & SceneState) const
{
	UMyModeInteractiveTool* NewTool = NewObject<UMyModeInteractiveTool>(SceneState.ToolManager);
...
UMyModeInteractiveToolProperties::UMyModeInteractiveToolProperties()
{
...
void UMyModeInteractiveTool::SetWorld(UWorld* World)
{
	check(World);
...
void UMyModeInteractiveTool::Setup()
{
	...
	Properties = NewObject<UMyModeInteractiveToolProperties>(this, "Measurement");
...
void UMyModeInteractiveTool::OnUpdateModifierState(int ModifierID, bool bIsOn)
{
...
FInputRayHit UMyModeInteractiveTool::CanBeginClickDragSequence(const FInputDeviceRay& PressPos)
{
...
void UMyModeInteractiveTool::OnClickPress(const FInputDeviceRay& PressPos)
{
...
void UMyModeInteractiveTool::OnClickDrag(const FInputDeviceRay& DragPos)
{
	UpdatePosition(DragPos.WorldRay);
}


FInputRayHit UMyModeInteractiveTool::FindRayHit(const FRay& WorldRay, FVector& HitPos)
{
...
void UMyModeInteractiveTool::UpdatePosition(const FRay& WorldRay)
{
...
void UMyModeInteractiveTool::UpdateDistance()
{
	Properties->Distance = FVector::Distance(Properties->StartPoint, Properties->EndPoint);
}


void UMyModeInteractiveTool::OnPropertyModified(UObject* PropertySet, FProperty* Property)
{
...
void UMyModeInteractiveTool::Render(IToolsContextRenderAPI* RenderAPI)
{
